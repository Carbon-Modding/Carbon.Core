...
if(target.Contains("Unix"))
{
	...
	Files.Copy(Path(Home, "Carbon.Core", "Carbon.Native", "target", "x86_x64-unknown-linux-gnu", cargoTarget, "libCarbonNative.so"), Path(Home, "Release", ".tmp", target, "carbon", "native"));
}
else
{
